...
public sealed class RequestEmailVerificationInputValidatorTests
{
    private readonly RequestEmailVerificationInputValidator _validator = new();
    ...
    public void Validate_WithEmailAtMaximumLength_IsValid()
    {
        ...
        ValidationResult result = _validator.Validate(
            new RequestEmailVerificationInput(email));
    ...
    public void Validate_WithMissingEmail_ReturnsRequiredError(string? email)
    {
        AssertSingleError(
            ...
            nameof(RequestEmailVerificationInput.Email),
            "Email is required.");
    }
    ...
    private static RequestEmailVerificationInput CreateValidInput()
    {
        return new RequestEmailVerificationInput("person@example.com");
    }
