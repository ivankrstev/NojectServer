...
namespace NojectServer.Middlewares
{
    public class VerifyProjectAccessHub : IHubFilter
    {
        ...
        private readonly List<string> _methodsRequiringMiddleware = new() { "ProjectJoin", "AddTask", "ChangeValue", "DeleteTask", "CompleteTask", "UncompleteTask", "IncreaseLevel", "DecreaseLevel" };
